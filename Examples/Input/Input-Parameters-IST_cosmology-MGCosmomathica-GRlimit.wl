...
fiducialModel={OmegaMref,Omegabref,hubbleref,nsref,sigma8ref};
parnamesModel={Omegam,Omegab , hubble,ns,sigma8};
parlabelsModel={"Om","Ob", "h","ns","s8"};
...
OmegaExtraMatterSpecies->Omeganuref, sigma8reference->sigma8ref, 
...
?activateModifiedGravity


(*SetOptions[LCDMCAMBPsPre, activateModifiedGravity->"mueta-param"];*)
...
(*parametersModifiedGravity[E11]*)


(*parametersModifiedGravity[E22, $paramoptions]*)


(*parametersModifiedGravity[fOfR0]*)
