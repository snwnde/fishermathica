...
If[FileExistsQ[specsDir<>specsFiles["Euclid-ndens"]], Print["Euclid specifications for nofz: file exists"]]
If[FileExistsQ[specsDir<>specsFiles["Euclid-bias"]], Print["Euclid specifications for bias: file exists"]]
